...
<Cards>
  ...
  >
    Add authentication, authorization, rate limiting, and access control to protect your tools and manage users.
  </Card>
  ...
  >
    Improve performance and reduce costs with intelligent caching strategies for tool responses.
  </Card>
</Cards>
...
[Start building →](/plugins/creating-plugins)
...
Complete examples of common enterprise patterns using the MCP Proxy Wrapper.

<Callout type="info">
  All examples are production-ready and include proper error handling, logging, and security best practices.
</Callout>

/**
 * @file improved-test.js
 * @version 1.0.0
 * 
 * A test for the improved MCP Proxy Wrapper that can intercept tools registered before wrapping
 */

import { McpServer } from '@modelcontextprotocol/sdk/server/mcp.js';
import { wrapWithProxy } from './improved-proxy-wrapper.js';
import { z } from 'zod';
...
async function runTests() {
  ...
  try {
    ...
    console.log('IMPORTANT: With the improved wrapper, hooks ARE called for tools registered BEFORE wrapping!');
  } catch (error) {
